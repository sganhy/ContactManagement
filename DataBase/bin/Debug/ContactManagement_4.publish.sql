...
GO
ALTER TABLE [dbo].[ContactRole] WITH NOCHECK
...
ALTER TABLE [dbo].[Contact] WITH CHECK CHECK CONSTRAINT [FK_Contact_Address];

ALTER TABLE [dbo].[ContactRole] WITH CHECK CHECK CONSTRAINT [FK_ContactRole_Company];

ALTER TABLE [dbo].[ContactRole] WITH CHECK CHECK CONSTRAINT [FK_ContactRole_Contact];
